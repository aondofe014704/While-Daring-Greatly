...
int phoneBook = scanner.nextInt();
	switch(phoneBook){
		...
		switch(options){
			...
			break;
			default: System.out.println("end of options");
...
case2: System.out.println("Messages");
...
System.out.println("Enter 1 or 3 to set1 options");
int setOptions = scanner.nextInt();
switch(setOptions){
...
System.out.println("1. Delivery reports\n2.Reply via same centre\3.Character support");

int setCommon = scanner.nextInt();
switch(setCommon){
